<div class="media well well-small span6">
  ...
  <div class="media-body">
    <h4 class="media-heading"><a href="<?php echo JRoute::_('index.php?option=com_lendr&view=profile&layout=profile&id='.$this->profile->id); ?>"><?php echo $this->profile->name; ?></a></h4>
